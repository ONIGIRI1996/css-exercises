...
### Self Check
- Did you properly chain class selectors for each rule? Answer: I believe i did
- Does the `proportioned` image retain its original square proportions? Answer: Yes
- Does the `distorted` image end up looking squished and, well, distorted? Answer: Squished, Yes!
